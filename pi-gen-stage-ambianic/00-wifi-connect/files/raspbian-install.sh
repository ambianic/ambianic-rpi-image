...
# this file was forked from https://github.com/homebridge/homebridge-raspbian-image/blob/master/stage3_homebridge/02-wifi-connect/files/raspbian-install.sh
